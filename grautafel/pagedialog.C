...
{
  formatList.append(QPageSize::Custom);
  formatList.append(QPageSize::A2);
  formatList.append(QPageSize::A3);
  formatList.append(QPageSize::A4);
  formatList.append(QPageSize::A5);
  formatList.append(QPageSize::A6);
}

int PageFormatModel::defaultRowIndex() {
  return formatList.indexOf(QPageSize::A4);
}
...
QVariant PageFormatModel::data(const QModelIndex &index, int role) const
{
    ...
    {
        QPageSize::PageSizeId theId = formatList[index.row()];
        switch(index.column()) {
          case 0:
            return theId;
          case 1:
